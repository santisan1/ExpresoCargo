...
import { can, downloadCsv, getDestination, getProductType, getWeight } from '../utils/format'
...
export default function Packages() {
  ...
  return <div className="page-stack"><div className="page-title"><div><h2>Listado de paquetes</h2><p>Filtros operativos y exportaciones simuladas WMS/TMS/ERP.</p></div><div className="actions">{can(profile, 'packages.create') && <Link to="/packages/new" className="btn btn-primary">Nuevo paquete</Link>}<button className="btn" onClick={exportCsv}>Exportar CSV para ERP</button><button className="btn" onClick={() => setRouteOpen(true)}>Generar hoja de ruta TMS</button></div></div>
