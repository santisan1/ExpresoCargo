...
export default function PackageDetail({ id }) {
  ...
  return <div className="page-stack"><div className="page-title"><div><h2>Detalle de trazabilidad</h2><p>Guía {pkg.guideNumber} · QR/barra {pkg.barcodeValue || pkg.qrPayload}</p></div><div className="actions no-print"><button className="btn btn-primary" onClick={() => generatePackageLabelPdf(pkg, zones)}>Descargar etiqueta PDF</button><StatusBadge status={pkg.currentStatus} /></div></div>
